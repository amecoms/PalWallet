...
class CashOutConfirmationSheet extends StatelessWidget {
  final double amount,change;
  final String currency;
  const CashOutConfirmationSheet(this.amount, this.change, this.currency,{super.key});
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    4.verticalSpace,
                    Text(
                      '${appLanguage(context).preview} ${appLanguage(context).cash_out}',
