...
class RequestMoneyConfirmationSheet extends StatelessWidget {
  final double amount,change;
  final String currency;
  const RequestMoneyConfirmationSheet(this.amount, this.change, this.currency,{super.key});
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    4.verticalSpace,
                    Text(
                      appLanguage(context).preview_request,
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: Text(
                            appLanguage(context).you_will_get,
                            style: appTheme(context).textTheme.headlineLarge!.copyWith(
                              fontWeight: Dimension.textRegular
                            ),
                          ),
                        ...
                        Text(
                          '${(amount - change).toStringAsFixed(1)} $currency',
                          style: appTheme(context).textTheme.headlineLarge!.copyWith(
                            fontWeight: Dimension.textRegular
                          ),
                        )
