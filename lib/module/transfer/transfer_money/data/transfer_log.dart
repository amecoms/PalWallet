...
class Response {
  ...
  Response.fromJson(dynamic json) {
    transferHistory = json['transfer_history'] != null ? TransferHistory.fromJson(json['transfer_history']) : null;
    search = json['search'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (transferHistory != null) {
      map['transfer_history'] = transferHistory?.toJson();
    }
    map['search'] = search;
    return map;
  }
...
class TransferHistory {
  ...
  TransferHistory.fromJson(dynamic json) {
